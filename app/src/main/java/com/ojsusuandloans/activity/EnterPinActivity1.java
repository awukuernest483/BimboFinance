...
import com.ojsusuandloans.MainActivity;
import com.ojsusuandloans.R;
import com.ojsusuandloans.andrognito.pinlockview.IndicatorDots;
import com.ojsusuandloans.andrognito.pinlockview.PinLockListener;
import com.ojsusuandloans.andrognito.pinlockview.PinLockView;
import com.ojsusuandloans.fingerprint.FingerPrintListener;
import com.ojsusuandloans.fingerprint.FingerprintHandler;
import com.ojsusuandloans.util.Animate;
import com.ojsusuandloans.util.Utils;
...
public class EnterPinActivity1 extends AppCompatActivity {
    ...
    public static Intent getIntent(Context context, boolean setPin) {
        Intent intent = new Intent(context, EnterPinActivity1.class);
    ...
    private void setPin(String pin) {
        if (mFirstPin.equals("")) {
            ...
            if (pin.equals(mFirstPin)) {
                ...
                setResult(RESULT_OK);
                Toast.makeText(getApplicationContext(),"Pin has been set successfully",Toast.LENGTH_SHORT).show();
                SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(this);
                SharedPreferences.Editor editor = preferences.edit();
                editor.putString("Hassetpin","True");
                editor.apply();
                finish();
            } else {
                shake();
    ...
    private void checkPin(String pin) {
        if (Utils.sha256(pin).equals(getPinFromSharedPreferences())) {
            setResult(RESULT_OK);
            startActivity(new Intent(EnterPinActivity1.this, MainActivity.class));
            finish();
        } else {
            shake();
    ...
    private void checkForFingerPrint() {
        ...
        final FingerPrintListener fingerPrintListener = new FingerPrintListener() {
            ...
            public void onError(CharSequence errorString) {
                Toast.makeText(EnterPinActivity1.this, errorString, Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onHelp(CharSequence helpString) {
                Toast.makeText(EnterPinActivity1.this, helpString, Toast.LENGTH_SHORT).show();
            }
